...
constexpr ModuleLUT_t ModuleLUT[] = {
    ...
    {fuzzing::datasource::ID("Cryptofuzz/Module/liboqs"), "liboqs"},
...
constexpr OperationLUT_t OperationLUT[] = {
    ...
    {fuzzing::datasource::ID("Cryptofuzz/Operation/OQS_KEM_SelfTest"), "OQS_KEM_SelfTest"},
    {fuzzing::datasource::ID("Cryptofuzz/Operation/OQS_SIG_SelfTest"), "OQS_SIG_SelfTest"},
