...
modules.Add( Module("BouncyCastle") )
modules.Add( Module("CPPCrypto") )
modules.Add( Module("CPU") )
modules.Add( Module("Constantine") )
modules.Add( Module("Crypto++") )
modules.Add( Module("D") )
modules.Add( Module("Decred-uint256") )
modules.Add( Module("EverCrypt") )
modules.Add( Module("Geth") )
modules.Add( Module("Golang") )
modules.Add( Module("Goldilocks") )
modules.Add( Module("Google-Integers") )
modules.Add( Module("Java") )
modules.Add( Module("Kryptology") )
modules.Add( Module("Linux") )
modules.Add( Module("Microsoft-Calculator") )
...
modules.Add( Module("PSA-Crypto") )
modules.Add( Module("Pornin-BinGCD") )
modules.Add( Module("QuickJS") )
modules.Add( Module("Reference implementations") )
modules.Add( Module("Ring") )
modules.Add( Module("RustCrypto") )
modules.Add( Module("Shamatar") )
modules.Add( Module("SkaleSolidity") )
modules.Add( Module("SolidityMath") )
modules.Add( Module("Starkware") )
modules.Add( Module("SymCrypt") )
modules.Add( Module("V8") )
modules.Add( Module("V8-embedded") )
modules.Add( Module("Veracrypt") )
modules.Add( Module("Zig") )
modules.Add( Module("arkworks-algebra") )
modules.Add( Module("aurora-engine-modexp") )
modules.Add( Module("bc") )
...
modules.Add( Module("faheel-BigInt") )
modules.Add( Module("ff") )
modules.Add( Module("gnark-bn254") )
modules.Add( Module("google-bn256") )
modules.Add( Module("holiman-uint256") )
modules.Add( Module("intx") )
modules.Add( Module("jsbn") )
modules.Add( Module("k256") )
modules.Add( Module("kilic-bls12-381") )
modules.Add( Module("libdivide") )
...
modules.Add( Module("nim-bigints") )
modules.Add( Module("nimcrypto") )
modules.Add( Module("noble-bls12-381") )
modules.Add( Module("noble-curves") )
modules.Add( Module("noble-ed25519") )
modules.Add( Module("noble-hashes") )
modules.Add( Module("noble-secp256k1") )
modules.Add( Module("num-bigint") )
modules.Add( Module("pairing_ce") )
modules.Add( Module("pasta_curves") )
modules.Add( Module("polygon-zkevm-prover") )
modules.Add( Module("prysmaticlabs-hashtree") )
modules.Add( Module("py_ecc") )
modules.Add( Module("relic") )
modules.Add( Module("rust-uint") )
...
modules.Add( Module("spl-math") )
modules.Add( Module("stint") )
modules.Add( Module("substrate-bn") )
modules.Add( Module("tiny-keccak") )
...
operations.Add( Operation("BLS_G1_MultiExp") )
...
operations.Add( Operation("BignumCalc_Mod_Goldilocks") )
...
operations.Add( Operation("BignumCalc_Mod_Vesta_P") )
operations.Add( Operation("BignumCalc_Mod_Vesta_R") )
operations.Add( Operation("CMAC") )
operations.Add( Operation("DH_Derive") )
operations.Add( Operation("DH_GenerateKeyPair") )
operations.Add( Operation("DSA_GenerateKeyPair") )
operations.Add( Operation("DSA_GenerateParameters") )
operations.Add( Operation("DSA_PrivateToPublic") )
operations.Add( Operation("DSA_Sign") )
operations.Add( Operation("DSA_Verify") )
operations.Add( Operation("Digest") )
operations.Add( Operation("ECCSI_Sign") )
operations.Add( Operation("ECCSI_Verify") )
operations.Add( Operation("ECC_GenerateKeyPair") )
operations.Add( Operation("ECC_Point_Add") )
operations.Add( Operation("ECC_Point_Cmp") )
operations.Add( Operation("ECC_Point_Dbl") )
operations.Add( Operation("ECC_Point_Mul") )
operations.Add( Operation("ECC_Point_Neg") )
operations.Add( Operation("ECC_Point_Sub") )
...
operations.Add( Operation("KDF_SRTCP") )
operations.Add( Operation("KDF_SRTP") )
...
operations.Add( Operation("OQS_KEM_SelfTest") )
operations.Add( Operation("OQS_SIG_SelfTest") )
...
ciphers.Add( Cipher("KUZNYECHIK_CBC") )
ciphers.Add( Cipher("KUZNYECHIK_CFB") )
ciphers.Add( Cipher("KUZNYECHIK_CTR") )
...
ciphers.Add( Cipher("AES_128_SIV_CMAC", True) )
ciphers.Add( Cipher("AES_192_EAX", True) )
ciphers.Add( Cipher("AES_192_GCM", True) )
ciphers.Add( Cipher("AES_192_SIV_CMAC", True) )
...
ciphers.Add( Cipher("AES_256_EAX", True) )
...
ciphers.Add( Cipher("AES_256_SIV_CMAC", True) )
...
digests.Add( Digest("BASH224", 28) )
digests.Add( Digest("BASH256", 32) )
digests.Add( Digest("BASH384", 48) )
digests.Add( Digest("BASH512", 64) )
...
digests.Add( Digest("FNV32", 4) )
digests.Add( Digest("FNV64", 8) )
digests.Add( Digest("FNVA32", 4) )
digests.Add( Digest("FNVA64", 8) )
digests.Add( Digest("FSB_160", 20) )
digests.Add( Digest("FSB_224", 28) )
digests.Add( Digest("FSB_256", 32) )
digests.Add( Digest("FSB_384", 48) )
digests.Add( Digest("FSB_512", 64) )
...
digests.Add( Digest("K12_256", 32) )
digests.Add( Digest("K12_512", 64) )
...
digests.Add( Digest("LSH224", 28) )
digests.Add( Digest("LSH256", 32) )
digests.Add( Digest("LSH384", 48) )
digests.Add( Digest("LSH512", 64) )
digests.Add( Digest("LSH512_256", 32) )
...
digests.Add( Digest("SHABAL_256", 32) )
digests.Add( Digest("SHABAL_512", 64) )
digests.Add( Digest("SHAKE128") )
digests.Add( Digest("SHAKE256") )
digests.Add( Digest("SHAKE256_114") )
...
ecc_curves.Add( ECC_Curve("sect131r2",
                          bits=131,
                          prime="2722258935367507707706996859454145691917",
...
ecc_curves.Add( ECC_Curve("sect571k1",
                          bits=571,
                          prime="7729075046034516689390703781863974688597854659412869997314470502903038284579120849072387533163845155924927232063004354354730157322085975311485817346934161497393961629647909",
                          a="0",
                          b="1",
...
ecc_curves.Add( ECC_Curve("sect239k1",
                          bits=233,
                          prime="883423532389192164791649115746868590639471499359017658131558014629445633",
                          a="0",
                          b="1",
...
ecc_curves.Add( ECC_Curve("sect409k1",
                          bits=409,
                          prime="1322111937580497197903830616065542079656809365928562438569297590548811582472622691650378420879430724437687334722581078999041",
                          a="0",
                          b="1",
...
ecc_curves.Add( ECC_Curve("sect233k1",
                          bits=233,
                          prime="13803492693581127574869511724554050904902217944359662576256527028453377",
                          a="0",
                          b="1",
...
ecc_curves.Add( ECC_Curve("sect283k1",
                          bits=283,
                          prime="15541351137805832567355695254588151253139254712417116170014499277911234281641667989665",
                          a="0",
                          b="1",
...
ecc_curves.Add( ECC_Curve("wap_wsg_idm_ecid_wtls1",
                          bits=113,
                          prime="10384593717069655257060992658440705",
                          a="1",
                          b="1",
...
ecc_curves.Add( ECC_Curve("sect163r1",
                          bits=163,
                          prime="11692013098647223345629478661730264157247460344009",
...
ecc_curves.Add( ECC_Curve("wap_wsg_idm_ecid_wtls5",
                          bits=163,
                          prime="11692013098647223345629478661730264157247460344071",
...
ecc_curves.Add( ECC_Curve("sect193r1",
                          bits=193,
                          prime="12554203470773361527671578846415332832204710888928069058561",
...
ecc_curves.Add( ECC_Curve("alt_bn128",
                          bits=254,
...
ecc_curves.Add( ECC_Curve("BLS12_377",
                          ...
                          a="0",
                          b="1",
                          x="89363714989903307245735717098563574705733591463163614225748337416674727625843187853442697973404985688481508350822",
                          y="3702177272937190650578065972808860481433820514072818216637796320125658674906330993856598323293086021583822603349",
...
ecc_curves.Add( ECC_Curve("sm2p256v1",
                          ...
                          x="22963146547237050559479531362550074578802567295341616970375194840604139615431",
                          y="85132369209828568825618990617112496413088388631904505083283536607588877201568",
                          order_min_1="115792089210356248756420345214020892766061623724957744567843809356293439045922",
...
calcops.Add( CalcOp("AddMul(A,B,C)") )
calcops.Add( CalcOp("And(A,B)") )
calcops.Add( CalcOp("BinCoeff(A,B)") )
calcops.Add( CalcOp("Bit(A,B)") )
calcops.Add( CalcOp("Cbrt(A)") )
calcops.Add( CalcOp("CbrtRem(A)") )
calcops.Add( CalcOp("ClearBit(A,B)") )
calcops.Add( CalcOp("Cmp(A,B)") )
calcops.Add( CalcOp("CmpAbs(A,B)") )
calcops.Add( CalcOp("CondAdd(A,B,C)") )
calcops.Add( CalcOp("CondSet(A,B)") )
calcops.Add( CalcOp("CondSub(A,B,C)") )
calcops.Add( CalcOp("Conjugate(A)") )
calcops.Add( CalcOp("CyclotomicSqr(A)") )
calcops.Add( CalcOp("Div(A,B)") )
calcops.Add( CalcOp("Exp(A,B)") )
calcops.Add( CalcOp("Exp2(A)") )
calcops.Add( CalcOp("ExpMod(A,B,C)") )
calcops.Add( CalcOp("ExtGCD_X(A,B)") )
calcops.Add( CalcOp("ExtGCD_Y(A,B)") )
calcops.Add( CalcOp("Factorial(A)") )
calcops.Add( CalcOp("Fibonacci(A)") )
calcops.Add( CalcOp("FrobeniusMap(A,B)") )
calcops.Add( CalcOp("GCD(A,B)") )
calcops.Add( CalcOp("HamDist(A,B)") )
...
calcops.Add( CalcOp("MulDiv(A,B,C)") )
calcops.Add( CalcOp("MulDivCeil(A,B,C)") )
calcops.Add( CalcOp("MulMod(A,B,C)") )
calcops.Add( CalcOp("Neg(A)") )
calcops.Add( CalcOp("NegMod(A,B)") )
calcops.Add( CalcOp("Not(A)") )
calcops.Add( CalcOp("Nthrt(A,B)") )
calcops.Add( CalcOp("NthrtRem(A,B)") )
calcops.Add( CalcOp("NumBits(A)") )
calcops.Add( CalcOp("NumLSZeroBits(A)") )
calcops.Add( CalcOp("One()") )
calcops.Add( CalcOp("Or(A,B)") )
calcops.Add( CalcOp("Prime()") )
calcops.Add( CalcOp("Primorial(A)") )
calcops.Add( CalcOp("RRot(A,B,C)") )
calcops.Add( CalcOp("RShift(A,B)") )
calcops.Add( CalcOp("Rand()") )
calcops.Add( CalcOp("RandMod(A)") )
calcops.Add( CalcOp("RandRange(A,B)") )
calcops.Add( CalcOp("Ressol(A,B)") )
calcops.Add( CalcOp("SDiv(A,B)") )
...
calcops.Add( CalcOp("SqrtCeil(A)") )
calcops.Add( CalcOp("SqrtMod(A,B)") )
calcops.Add( CalcOp("SqrtRem(A)") )
